...
public class CoolVideo extends ThreadOpMode {
    ...
    public void mainLoop() {
        ...
        telemetry.addData("Y Pos", pos.y);
        telemetry.addData("ForWardDone", ForWardDone);
        telemetry.update();
    ...
    public void InTake() {
        if (colorSensor.red() < 140) {
            IServo1.setPower(0.1);
            IServo2.setPower(-0.1);
        } else if (colorSensor.red() > 190) {
            IServo1.setPower(0);
            IServo2.setPower(0);
        }
    }
